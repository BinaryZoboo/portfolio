      ...
      <div className="flex w-full flex-col items-center space-y-6 sm:flex-row sm:space-y-0">
        ...
        <div className="flex w-full flex-col space-y-3 text-center sm:w-2/3 sm:text-left">
          <p className="text-zinc-400">
            <span className="text-zinc-500 opacity-80">{"<span>"}</span>Hey, je
            m&apos;appelle Nathan
            <span className="text-zinc-500 opacity-80">{"</span>"}</span>
          </p>

          <h1 className="text-balance text-4xl font-bold text-black md:text-5xl lg:text-6xl dark:text-white">
            <p className="flex flex-wrap text-black dark:text-white">
              Junior&nbsp;
              <span className="text-sky-500 dark:text-atlantis">{"{Web}"}</span>
          ...
          <div className="font-mono text-zinc-800 dark:text-zinc-300">
            ...
            <span className="text-green-700 dark:text-atlantis"> NodeJS</span>,
            <span className="text-green-700 dark:text-atlantis"> React</span>,
            <span className="text-green-700 dark:text-atlantis">
              {" "}
              Javascript
            </span>
            , et
            <span className="text-green-700 dark:text-atlantis"> Tailwind</span>
